...
async def ee(client, message):
    ...
    if stats:
        ...
        await message.reply('vcg belum aktif, silahkan aktifkan terlebih dahulu')
...
async def m_cb(b, cb):
    ...
    if type_ == 'pause':
        if (
            ...
            await cb.answer('Assistant belum terhubung ke vcg saat ini', show_alert=True)
        else:
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await USER.send_message(message.chat.id,"Saya bergabung ke grup ini untuk memainkan musik di VCG")
                              await lel.edit(
                                  "<b>Helper userbot bergabung ke dalam grup anda</b>",
                              )
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nAtau tambahkan secara manual @veezasisstant ke Grup anda dan coba lagi</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot tidak ada di dalam grup ini, Minta admin untuk menambahkan Assistant {user.first_name} secara manual</i>"
        )
        return     
    ...
    keyboard = InlineKeyboardMarkup(
            [   
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "Owner Veez Music", url="https://t.me/dlwrml"
                    )
                ],
                [       
                    InlineKeyboardButton(
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          try:
                              ...
                              await lel.edit(
                                  "<b>Tambahkan saya sebagai admin di grup ini terlebih dahulu</b>",
                              )
                              return

                          try:
                              await USER.join_chat(invitelink)
                              await USER.send_message(message_.chat.id,"Saya bergabung ke grup ini untuk memainkan musik di VCG")
                              await lel.edit(
                                  "<b>Helper userbot bergabung ke dalam grup anda</b>",
                              )
                              ...
                              #print(e)
                              await lel.edit(
                                  f"<b>🔴 Flood Wait Error 🔴 \nAssistant {user.first_name} tidak dapat bergabung ke grup anda karena banyaknya permintaan bergabung untuk userbot! Pastikan pengguna tidak dibanned dalam grup."
                                  "\n\nAtau tambahkan secara manual @veezasisstant ke Grup Anda dan coba lagi</b>",
                              )
                              pass
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot tidak ada dalam grup ini, Minta admin untuk menambahkan assistant {user.first_name} secara manual</i>"
        )
        return                            
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await res.edit(
            "Foundly Nothing !, Anda Harus melatih bahasa inggris anda."
        )
        print(str(e))
        is_playing = False
        return
